...
#________________________TESTS_______________________________________________________
...
def test_left_join():
    ...
    assert left_join(h1,h2)=="[['wrath', 'anger', 'delight'], ['outfit', 'garb', None], ['diligent', 'employed', 'idle'], ['guide', 'usher', 'follow'], ['fond', 'enamored', 'averse']],"
...
def test_no_common():
    ...
    assert left_join(h1,h2) == "[['wrath', 'anger', None], ['outfit', 'garb', None], ['diligent', 'employed', None], ['guide', 'usher', None], ['fond', 'enamored', None]],"
